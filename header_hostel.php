...
{ 
  	$uemail=$_SESSION['hostel'];

  $ql = "SELECT * FROM hostel WHERE email = '$uemail'";
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="hostelindex.php">
		  <!-- <img src="images/3d logo.png"> -->
		  </a>
          <a class="navbar-brand brand-logo-mini" href="hostelindex.php"> <img src="images/3d logo.png"> </a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="#" data-bs-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">Hostel Login</span>
            </a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-date dropdown">
            <a class="nav-link d-flex justify-content-center align-items-center" href="hostelindex.php">
	...
	<div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
		      ...
		      <li class="nav-item">
            <a class="nav-link" href="hostelindex.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="change_password_hostel.php">
              <i class="typcn typcn-device-desktop menu-icon"></i>
