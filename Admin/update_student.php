...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE `student` set name='$name',email='$email',password='$password',stu_depart='$stu_depart',enrolment_no='$enrolment_no',contact='$contact' WHERE sno='$sno'"; 
										...
										<div class="form-wrap">
											<form action="" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<input class="form-control" value=<?php echo $row['email']; ?> type='email' name="email" placeholder="Please Enter Email" required>
												</div>
												
												<div class="form-group">
													<label class="control-label mb-10 text-left">Please Enter Student Department <span class="help"></span></label>
													<input class="form-control"  value=<?php echo $row['stu_depart']; ?> type='text' name="stu_depart" placeholder="Please Enter Student Department"  required>
												</div>
												
												<div class="form-group">
													<label class="control-label mb-10 text-left">Please Enter Student Enrolment Number <span class="help"></span></label>
													<input class="form-control" value=<?php echo $row['enrolment_no']; ?> type='text' name="enrolment_no" placeholder="Please Enter Student Enrolment Number" required>
												</div>
												
												<div class="form-group">
													<label class="control-label mb-10 text-left">Please Enter Student Contact Number <span class="help"></span></label>
													<input class="form-control" value=<?php echo $row['contact']; ?> type='number' name="contact"  placeholder="Please Enter Student Contact Number" required>
												</div>
												
												<div class="form-group">
													<label class="control-label mb-10 text-left">Please Enter Password <span class="help"></span></label>
													<input class="form-control" value=<?php echo $row['password']; ?> type='password' name="password" placeholder="Please Enter Password" required>
												</div>
