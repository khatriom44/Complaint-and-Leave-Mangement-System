...
$sno = $_GET['did'];
$sql="SELECT * FROM `subject` WHERE sno='$sno'";
...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE `subject` set name='$name'WHERE sno='$sno'"; 
										...
										<div class="form-wrap">
											<form action="" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<textarea class="form-control" rows="5" name="name" placeholder="Please Enter Department Name" required><?php echo $row['name']; ?></textarea>
												</div>
