...
include("header.php");
$sno = $_GET['did'];
$sql="SELECT * FROM `hod` WHERE sno='$sno'";
...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE `hod` set name='$name',email='$email',password='$password' WHERE sno='$sno'"; 
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Add Hod</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="index.php">Dashboard</a></li>
							<li><a href="hod.php"><span>Back</span></a></li>
							<li class="active"><span>Add Hod</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Add Hod</h6>
									</div>
