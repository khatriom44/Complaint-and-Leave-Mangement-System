...
{
    $did = $_GET['did'];
    $sql = "DELETE FROM student WHERE sno='$did'";
						...
						<div class="panel panel-default card-view">
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
										...
										<div class="col-sm-4">
										<a href="student_add.php"><button class="btn btn-default btn-block" style="margin-bottom:20px;"><i class="fa fa-plus" aria-hidden="true"></i> Create New Record</button></a>
										</div>
										</div>
											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												<tbody>
                                                    ...
                                                    <tr>
														...
														<td><?php echo $row['stu_depart'];?></td>
														<td><?php echo $row['enrolment_no'];?></td>
														<td><?php echo $row['contact'];?></td>
														<td><?php echo $row['password'];?></td>
				
														<td>
															<a class='edit btn btn-sm btn-primary' href='./update_student.php?did=<?php echo $row['sno']; ?>'>Update</a>
															<a class='edit btn btn-sm btn-primary' href='./student.php?did=<?php echo $row['sno']; ?>' onclick='return checkdelete()'>Delete</a>
														</td>
													</tr>
