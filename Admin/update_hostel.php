...
include("header.php");
$sno = $_GET['did'];
$sql="SELECT * FROM `hostel` WHERE sno='$sno'";
...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE `hostel` set name='$name',email='$email',password='$password',h_sno='$hostels' WHERE sno='$sno'"; 
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Add Warden</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="index.php">Dashboard</a></li>
							<li><a href="hostel.php"><span>Back</span></a></li>
							<li class="active"><span>Add Warden</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Add Warden</h6>
									</div>
										...
										<div class="form-wrap">
											<form action="" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group">
                                                    ...
                                                    <label for="sel1">Select Hostel From The Dropdown:</label>
                                                    <select name='hostel' class="form-control" required>
                                                        <option></option>
                                                            <?php
                                                                $sql1 = "SELECT * FROM hostels";
