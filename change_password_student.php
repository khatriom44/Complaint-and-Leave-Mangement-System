...
if(isset($_REQUEST['login']))
{
    if(isset($_POST['op'])&& isset($_POST['np']) && isset($_POST['c_np'])){
        ...
        elseif($np !== $c_np){
            ...
            $sql = "SELECT password FROM `student` WHERE sno='$id' AND password='$op'";
            ...
            if($password !== $op){
                ...
                $sql1 = "UPDATE `student` SET password='$np' WHERE sno='$id'";
...
<body style="font-family: 'Quicksand', sans-serif;">
  <div class="container-scroller">
    ...
    border-radius: 25px;">
                ...
                <a href="studentindex.php" style="text-align: center;">Back To Student Page</a>
