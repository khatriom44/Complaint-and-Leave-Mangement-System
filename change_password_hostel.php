...
if(isset($_REQUEST['login']))
{
    if(isset($_POST['op'])&& isset($_POST['np']) && isset($_POST['c_np'])){
        ...
        if(empty($op)){
            ...
            window.location.href='change_password_hostel.php';
            </script>");
        }
        elseif(empty($np)){
            echo ("<script LANGUAGE='JavaScript'>
        ...
        elseif($np !== $c_np){
            ...
            $email = $_SESSION['login_email_hostel'];
            $sql3 = "SELECT * from `hostel` WHERE email='$email'";
            ...
            $sql = "SELECT password FROM `hostel` WHERE sno='$id' AND password='$op'";
            ...
            if($password !== $op){
                ...
                $sql1 = "UPDATE `hostel` SET password='$np' WHERE sno='$id'";
...
<body style="font-family: 'Quicksand', sans-serif;">
  <div class="container-scroller">
    ...
    border-radius: 25px;">
                ...
                <a href="hostelindex.php" style="text-align: center;">Back To Hostel Page</a>
