...
$qu=mysqli_query($con,"select * from student where email='".$name."' AND password='".$password."'")or die(mysqli_error());
        ...
        <div class="row flex-grow">
          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-start p-3">
              ...
              <h6 class="font-weight-light" style="text-align:center;font-size: 20px;">Student Login Account</h6>
              <form class="pt-3" method='POST' action=''>
                <div class="form-group">
                  <label for="exampleInputEmail">Please Enter Email ID</label>
                  <div class="input-group">
                    <input type="email" name='email' class="form-control" id="exampleInputUsername1" required placeholder="Please Enter Email ID" style="border-left: 7px solid blue;
    border-radius: 25px;">
                  </div>
                </div>
                <div class="form-group">
